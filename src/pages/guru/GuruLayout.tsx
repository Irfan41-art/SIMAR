      ...
      `}>
        <div className="h-16 flex items-center px-6 border-b border-white/5">
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 bg-linear-to-br from-blue-600 to-purple-600 rounded-lg flex items-center justify-center shadow-lg shadow-blue-500/20">
              <span className="text-white font-black text-xs uppercase tracking-tighter">SM</span>
            </div>
            <h1 className="text-lg font-display font-black text-white tracking-tight">SIMAR <span className="text-purple-400">Guru</span></h1>
          </div>
        </div>
